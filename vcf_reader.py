    ...
    try:
        ...
        if gene_set:
            ...
            try:
                ...
                print(f"Skipping enrhichment analysis: {e}")
        ...
        insert_query = text("""
                            INSERT INTO patient_has_signature (patient_id, signature_id) 
                            VALUES (:patient_id, :signature_id);
                            """)
        ...
        if match:
            ...
            for signature_id in signature_names:
                session.execute(insert_query, {"patient_id": patient_id, "signature_id": signature_id})
            session.commit()
        else:
...
# process_vcf("/home/marti/MBHS/DBW/OncoTrack/oncotrack/files/PD4006a.vcf",3)